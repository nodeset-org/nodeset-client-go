...
func (c *V3StakeWiseClient) DepositData_Get(ctx context.Context, logger *slog.Logger, deployment string, vault ethcommon.Address) (stakewise.DepositDataData, error) {
	// Send the request
...
func (c *V3StakeWiseClient) DepositData_Post(ctx context.Context, logger *slog.Logger, deployment string, vault ethcommon.Address, depositData []beacon.ExtendedDepositData) error {
