...
// POST api/v3/core/node-address
func (s *V3CoreServer) nodeAddress(w http.ResponseWriter, r *http.Request) {
	...
	// Input validation
	var request v3core.NodeAddressRequest
	...
	// Register the node
	err = node.Register(sig, v3core.NodeAddressMessageFormat)
	if err != nil {
